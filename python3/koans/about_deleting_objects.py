...
class AboutDeletingObjects(Koan):
    ...
    def test_del_can_remove_attributes(self):
        ...
        self.assertRegex(err_msg1, r"'ClosingSale' object has no attribute 'toilet_brushes'")
        self.assertRegex(err_msg2, r"'ClosingSale' object has no attribute 'hamsters'")
